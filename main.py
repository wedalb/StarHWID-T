...
license_label = tk.Label(app, text="Enter your license:", font=("Arial", 14), bg=bg_color, fg="white")
...
submit_button = tk.Button(app, text="Submit", command=check_license, font=("Arial", 14), bg=bg_color, fg="white")
